...
_C.RPPG_MODEL.FREQ_ATT_POOL_SIZE = 8
_C.RPPG_MODEL.FREQ_ATT_TEMPORAL_KERNEL = 7
_C.RPPG_MODEL.FREQ_ATT_SHARPNESS = 10.0
...
_C.RPPG_DATA.TEST_CACHED_PATH = ""   # Single test preprocessed dir (backward compat)
_C.RPPG_DATA.TEST_CACHED_PATHS = []  # Multiple test preprocessed dirs
...
# ── Waveform Fine-tune (Stage-2) ──
_C.RPPG_FINETUNE = CN()
_C.RPPG_FINETUNE.EPOCHS          = 30
_C.RPPG_FINETUNE.PATIENCE        = 15
_C.RPPG_FINETUNE.LR_G            = 5e-5
_C.RPPG_FINETUNE.LR_D            = 2e-4
_C.RPPG_FINETUNE.LAMBDA_MSE      = 10.0
_C.RPPG_FINETUNE.LAMBDA_SPECTRAL = 1.0
_C.RPPG_FINETUNE.LAMBDA_ADV      = 0.1
_C.RPPG_FINETUNE.WARMUP_EPOCHS   = 5

# ── SpO2 Fine-tune (Stage-3) ──
_C.RPPG_SPO2_FINETUNE = CN()
